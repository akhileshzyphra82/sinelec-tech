<?php
/**
 * SINELEC TECH — Store Mock Data
 * Replace array population below with DB queries when connecting to database.
 * Structure mirrors the final DB schema: products, categories, manufacturers, services, etc.
 */
...
$storeData = [
    ...
    /* ── Manufacturers ───────────────────────────────────────── */
    'manufacturers' => [
        ['id' => 'st',        'name' => 'STMicroelectronics',     'country' => 'Switzerland',  'products' => 3],
        ['id' => 'ti',        'name' => 'Texas Instruments',      'country' => 'USA',           'products' => 5],
        ['id' => 'microchip', 'name' => 'Microchip Technology',   'country' => 'USA',           'products' => 3],
        ['id' => 'nxp',       'name' => 'NXP Semiconductors',     'country' => 'Netherlands',   'products' => 0],
        ['id' => 'infineon',  'name' => 'Infineon',               'country' => 'Germany',       'products' => 1],
        ['id' => 'onsemi',    'name' => 'ON Semiconductor',       'country' => 'USA',           'products' => 0],
        ['id' => 'adi',       'name' => 'Analog Devices',         'country' => 'USA',           'products' => 0],
        ['id' => 'renesas',   'name' => 'Renesas',                'country' => 'Japan',         'products' => 0],
        ['id' => 'vishay',    'name' => 'Vishay',                 'country' => 'USA',           'products' => 1],
        ['id' => 'rohm',      'name' => 'ROHM',                   'country' => 'Japan',         'products' => 0],
        ['id' => 'murata',    'name' => 'Murata',                 'country' => 'Japan',         'products' => 0],
        ['id' => 'wurth',     'name' => 'Wurth Elektronik',       'country' => 'Germany',       'products' => 0],
        ['id' => 'maxim',     'name' => 'Maxim Integrated',       'country' => 'USA',           'products' => 1],
        ['id' => 'silabs',    'name' => 'Silicon Labs',           'country' => 'USA',           'products' => 0],
        ['id' => 'nordic',    'name' => 'Nordic Semiconductor',   'country' => 'Norway',        'products' => 1],
        ['id' => 'espressif', 'name' => 'Espressif Systems',      'country' => 'China',         'products' => 1],
    ],
    ...
    'products' => [
        ...
        [
            ...
            'description' => '32-bit ARM Cortex-M3 microcontroller with 64KB Flash, 20KB RAM, 72MHz clock and multiple peripherals.',
            'features' => ['72 MHz Cortex-M3', '64KB Flash / 20KB RAM', 'USB, CAN, USART, SPI, I2C', 'LQFP-48 Package'],
            'datasheet' => '#', 'badge' => 'bestseller',
            'priceBreaks' => [['qty' => 1, 'price' => 285.00], ['qty' => 10, 'price' => 260.00], ['qty' => 100, 'price' => 230.00]],
        ...
        [
            ...
            'description' => '8-bit AVR microcontroller with 32KB ISP Flash, self-program capabilities. Arduino compatible.',
            'features' => ['20 MHz AVR Core', '32KB Flash / 2KB RAM', 'USART, SPI, I2C, PWM', 'Arduino Compatible'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 1, 'price' => 195.00], ['qty' => 10, 'price' => 175.00], ['qty' => 100, 'price' => 150.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => 'Enhanced Flash/EEPROM 8-bit Microcontroller with 10-bit A/D and multiple communication interfaces.',
            'features' => ['20 MHz', '14KB Flash / 368B RAM', 'A/D, USART, SPI, I2C', 'DIP-40 Package'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 240.00], ['qty' => 10, 'price' => 215.00]],
        ...
        [
            ...
            'description' => 'Dual-core Xtensa LX6 MCU with WiFi 802.11b/g/n and Bluetooth 4.2/BLE. 4MB Flash.',
            'features' => ['240 MHz Dual-core', '4MB Flash / 520KB SRAM', 'WiFi + Bluetooth 4.2/BLE', '38 GPIO pins'],
            'datasheet' => '#', 'badge' => 'hot',
            'priceBreaks' => [['qty' => 1, 'price' => 320.00], ['qty' => 10, 'price' => 290.00], ['qty' => 100, 'price' => 255.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => 'Mainstream 64 MHz Arm Cortex-M0+ MCU with 512KB Flash, 144KB RAM, USB and FDCAN.',
            'features' => ['64 MHz Cortex-M0+', '512KB Flash / 144KB RAM', 'USB, FDCAN, USART, SPI, I2C', 'LQFP-64 Package'],
            'datasheet' => '#', 'badge' => 'new',
            'priceBreaks' => [['qty' => 1, 'price' => 410.00], ['qty' => 10, 'price' => 375.00]],
        ...
        [
            ...
            'description' => '8-Bit Shift Registers With 3-State Output Registers. Serial-to-parallel conversion.',
            'features' => ['8-bit serial/parallel', '3-State outputs', 'Serial/parallel input', 'DIP-16 / SOIC-16'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 5, 'price' => 22.00], ['qty' => 50, 'price' => 18.00], ['qty' => 500, 'price' => 14.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => 'Quad 2-Input NAND Gate with high-speed CMOS logic. 5ns propagation delay.',
            'features' => ['4 × 2-input NAND', 'CMOS logic', '5ns propagation delay', 'DIP-14 Package'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 10, 'price' => 15.00], ['qty' => 100, 'price' => 12.00], ['qty' => 1000, 'price' => 9.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => 'General purpose operational amplifier with overload protection on input and output.',
            'features' => ['±22V supply', '1 MHz GBW', '25mA output current', 'DIP-8 / TO-5 Package'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 28.00], ['qty' => 10, 'price' => 24.00], ['qty' => 100, 'price' => 20.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        [
            ...
            'description' => 'Dual operational amplifier, single supply, wide supply range with large output swing.',
            'features' => ['Single supply: 3V–32V', 'Dual supply: ±1.5V–±16V', '1 MHz GBW', 'Large output swing'],
            'datasheet' => '#', 'badge' => 'bestseller',
            'priceBreaks' => [['qty' => 1, 'price' => 18.00], ['qty' => 10, 'price' => 15.00], ['qty' => 100, 'price' => 12.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        ...
        [
            ...
            'description' => '+5V fixed linear voltage regulator with 1.5A output current, short circuit protection.',
            'features' => ['+5V fixed output', '1.5A max output', 'Thermal shutdown', 'TO-220 Package'],
            'datasheet' => '#', 'badge' => 'bestseller',
            'priceBreaks' => [['qty' => 1, 'price' => 25.00], ['qty' => 10, 'price' => 22.00], ['qty' => 100, 'price' => 18.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => '3.3V LDO Linear Regulator with 800mA output current and 1.1V dropout voltage.',
            'features' => ['3.3V output', '800mA output', '1.1V dropout', 'SOT-223 / TO-252 Package'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 5, 'price' => 12.00], ['qty' => 50, 'price' => 10.00], ['qty' => 500, 'price' => 8.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        [
            ...
            'description' => '3A, 23V, 340kHz synchronous rectified step-down converter with 100% duty cycle.',
            'features' => ['3A output current', '4.75V–23V input range', '340 kHz switching frequency', '100% duty cycle'],
            'datasheet' => '#', 'badge' => 'new',
            'priceBreaks' => [['qty' => 1, 'price' => 85.00], ['qty' => 10, 'price' => 75.00], ['qty' => 100, 'price' => 65.00]],
            'isNew' => true, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => 'NPN general purpose transistor, low noise, 45V, 100mA, ideal for audio and switching.',
            'features' => ['NPN silicon', '45V Vce / 50V Vcbo', '100mA collector current', '300 MHz fT'],
            'datasheet' => '#', 'badge' => 'bestseller',
            'priceBreaks' => [['qty' => 10, 'price' => 4.00], ['qty' => 100, 'price' => 3.20], ['qty' => 1000, 'price' => 2.50]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => 'N-Channel power MOSFET, 100V, 33A, 44mΩ RDS(on). Ideal for switching and motor drives.',
            'features' => ['100V / 33A ratings', '44mΩ RDS(on)', 'TO-220 Package', 'Fast switching'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 45.00], ['qty' => 10, 'price' => 40.00], ['qty' => 100, 'price' => 35.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => 'Digital temperature and humidity sensor with single-wire interface. Calibrated digital output.',
            'features' => ['±0.5°C temp accuracy', '±2% RH accuracy', '−40°C to +80°C range', 'Single wire interface'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 1, 'price' => 120.00], ['qty' => 10, 'price' => 105.00], ['qty' => 100, 'price' => 90.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => '3-axis gyroscope + 3-axis accelerometer with built-in Digital Motion Processor via I2C.',
            'features' => ['3-axis gyro + 3-axis accel', 'I2C interface (up to 400kHz)', 'Digital motion processor', 'QFN-24 Package'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 1, 'price' => 95.00], ['qty' => 10, 'price' => 85.00], ['qty' => 100, 'price' => 72.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => 'Ultrasonic ranging module, 2cm–400cm non-contact distance measurement with ±3mm accuracy.',
            'features' => ['2cm – 400cm range', '±3mm accuracy', '40kHz ultrasonic', 'Trigger/Echo interface'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 55.00], ['qty' => 10, 'price' => 48.00], ['qty' => 100, 'price' => 40.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => 'Dual EIA-232 drivers/receivers with ±15kV ESD protection, single 5V supply.',
            'features' => ['Dual EIA-232 driver/receiver', '+5V only supply', '120kbps data rate', '±15kV ESD protection'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 38.00], ['qty' => 10, 'price' => 34.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        [
            ...
            'description' => '2.4GHz ISM band transceiver with 2Mbps air data rate and SPI interface.',
            'features' => ['2.4GHz ISM band', '2Mbps air data rate', 'SPI interface', '250kbps – 2Mbps configurable'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 1, 'price' => 75.00], ['qty' => 10, 'price' => 65.00], ['qty' => 100, 'price' => 55.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => '256Kbit (32K × 8) 2-wire serial EEPROM with hardware write protect and 1M write cycles.',
            'features' => ['256Kbit EEPROM', 'I2C up to 400kHz', '1M write cycles', '100-year data retention'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 32.00], ['qty' => 10, 'price' => 28.00], ['qty' => 100, 'price' => 24.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => 'Pack of 100 × 10kΩ ±5% 1/4W carbon film resistors, through-hole axial lead.',
            'features' => ['10kΩ ±5% tolerance', '1/4W power rating', 'Pack of 100', 'Through-hole axial'],
            'datasheet' => '#', 'badge' => 'bestseller',
            'priceBreaks' => [['qty' => 1, 'price' => 35.00], ['qty' => 10, 'price' => 30.00], ['qty' => 50, 'price' => 25.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        [
            ...
            'description' => 'Pack of 50 × 100µF 25V electrolytic capacitors, general purpose, 8mm × 12mm.',
            'features' => ['100µF ±20% capacitance', '25V rated voltage', 'Pack of 50', '8mm × 12mm dimensions'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 65.00], ['qty' => 10, 'price' => 58.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
        ...
        [
            ...
            'description' => '0.96-inch 128×64 OLED display module with SSD1306 driver chip and I2C interface.',
            'features' => ['128×64 pixels', 'I2C interface', '3.3V/5V compatible', 'Self-luminous OLED'],
            'datasheet' => '#', 'badge' => 'popular',
            'priceBreaks' => [['qty' => 1, 'price' => 185.00], ['qty' => 10, 'price' => 165.00], ['qty' => 100, 'price' => 145.00]],
            'isNew' => false, 'isFeatured' => true,
        ],
        [
            ...
            'description' => '16-character × 2-line alphanumeric LCD module with HD44780 controller and backlight.',
            'features' => ['16×2 characters', 'HD44780 compatible', '4/8-bit parallel interface', 'Backlight included'],
            'datasheet' => '#', 'badge' => null,
            'priceBreaks' => [['qty' => 1, 'price' => 110.00], ['qty' => 10, 'price' => 98.00], ['qty' => 100, 'price' => 85.00]],
            'isNew' => false, 'isFeatured' => false,
        ],
    ],
    ...
    'testimonials' => [
        [
            'name' => 'Rajesh Kumar',
            'company' => 'RK Electronics, Delhi',
            'rating' => 5,
            'text' => 'Ordered STM32 chips and got them programmed with our custom firmware. Fast service, genuine parts. Will order again!',
            'verified' => true,
        ],
        [
            'name' => 'Priya Sharma',
            'company' => 'TechMakers Lab, Bangalore',
            'rating' => 5,
            'text' => 'Excellent product quality and very fast shipping. The chip programming service saved us a lot of time.',
            'verified' => true,
        ],
        [
            'name' => 'Mohammed Ali',
            'company' => 'Robo Innovations, Hyderabad',
            'rating' => 4,
            'text' => 'Great range of components. Prices are competitive and customer support is helpful. Highly recommended.',
            'verified' => true,
        ],
        [
            'name' => 'Anita Patel',
            'company' => 'EduBot, Ahmedabad',
            'rating' => 5,
            'text' => 'We buy all our Arduino and ESP32 modules from Sinelec. Best prices and fast delivery in India.',
            'verified' => true,
        ],
    ],
    ...
    /* ── Banners ──────────────────────────────────────────────── */
    'banners' => [
        ['title' => "India's Premier Semiconductor Store",    'subtitle' => 'Genuine Components · Expert Programming · Fast Shipping', 'cta' => 'Shop Now',    'badge' => '250,000+ Products', 'bg' => 'primary'],
        ['title' => 'Chip Programming Service',               'subtitle' => 'Custom firmware flashed to your MCU — Arduino, STM32, PIC, ESP32', 'cta' => 'Learn More', 'badge' => 'Starting ₹499', 'bg' => 'secondary'],
        ['title' => 'Bulk Orders Welcome',                    'subtitle' => 'Competitive pricing on volume orders. Get a custom quote today.', 'cta' => 'Get Quote',   'badge' => 'Upto 40% Off',   'bg' => 'accent'],
    ],
];
